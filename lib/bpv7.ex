defmodule Bpv7 do
  ...
  def canonical_testblock do    # Test canonical block
    ...
    canonicalblockEins = %Canonical_Block{block_number: 1 , block_type_code: 1,\
    ...
    canonicalblockZwei = %Canonical_Block{block_number: 2 , block_type_code: 6,\
  ...
  def crccanonicalblocks(canonicalblocklist) do
    _crclist = Enum.map(canonicalblocklist, fn(n) -> CRC.crc_16(:erlang.term_to_binary(n)) end)
  end
end
